...
class ofxVideoGrabberSDK
{
	public:
		...
		virtual bool init( int _width = 320, int _height = 240, int _format = VID_FORMAT_RGB, int _targetFormat = VID_FORMAT_RGB , int _frameRate = 15, uint64_t _deviceGUID = -1 ) = 0;
