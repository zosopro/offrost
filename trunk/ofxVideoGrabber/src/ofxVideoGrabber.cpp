...
//--------------------------------------------------------------------
bool ofxVideoGrabber::initGrabber( int _width, int _height, int _format, int _targetFormat, int _frameRate, bool _useTexture, ofxVideoGrabberSDK *sdk, uint64_t _deviceGUID, ofxVideoGrabberSettings* _settings)
{
	videoGrabber = sdk;
	settings = _settings;
    bool initResult = videoGrabber->init( _width, _height, _format, _targetFormat, _frameRate, _deviceGUID);
